...
public class ClienteFactor {
    ...
    public static class ClienteRefact {
        private String nombre;
        private static double saldo;
        private Producto[] productosComprados;
        private int numProductosComprados;
        ...
        public void agregarProductoComprado(ClienteFactor.Producto producto) {
        }

        public void agregarProductoComprado(ClienteFactor.ClienteRefact.Producto producto) {
            productosComprados[numProductosComprados] = producto;
            numProductosComprados++;
        }
